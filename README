Some Bash Scripts for Linux 

installCuda5.sh - It installs CUDA5 with all the work necessary to correct the installation at Ubuntu 12.10. You might get it and change the 
parameters and file path as your needs then run it. Please acknowledge me for any trouble.

installCudaToUbuntu12_10Optimus.sh - More general script for installation of CUDA to NVIDIA Optimus kind of graphic cards. Before the installation
